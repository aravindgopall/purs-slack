...
type S = { routes :: { createChannel :: POST "/admin.conversations.create" { body :: CreateChannel, response :: CreateChannelResponse }
...
callInviteUsers client = do
  let ac = UserRequest { channel_id: "aravind-ch1", user_ids: ["aravindgopall"] }
  launchAff_ $ do
